    ...
    return (
      <Link
        ...
        className={cn(
          ...
          'hover:bg-meso-gold-500/15 hover:border-meso-gold-500/50 transition-colors',
          className
        )}
      >
        <div className="flex items-center gap-2">
          <Gift className="w-4 h-4 text-meso-gold-400" />
          <span className="text-sm text-meso-gold-400">
            Załóż konto → <strong>+50 pkt</strong>
          </span>
        </div>
        <ArrowRight className="w-4 h-4 text-meso-gold-400" />
      </Link>
    )
  }
  ...
  if (variant === 'checkout') {
    return (
      <div
        className={cn(
          'rounded-lg p-4',
          'bg-gradient-to-r from-meso-gold-500/10 to-meso-gold-500/5',
          'border border-meso-gold-500/20',
          className
        )}
      >
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-full bg-meso-gold-500/20 flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex-1">
            ...
            <Link href="/register">
              <Button
                variant="outline"
                size="sm"
                className="border-meso-gold-500/30 text-meso-gold-400 hover:bg-meso-gold-500/10"
              >
                Załóż konto teraz
  ...
  return (
    <div
      className={cn(
        ...
        'bg-gradient-to-br from-meso-gold-500/15 via-meso-gold-500/10 to-transparent',
        'border border-meso-gold-500/30',
        className
      )}
    >
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 rounded-full bg-meso-gold-500/20 flex items-center justify-center flex-shrink-0">
          <Gift className="w-6 h-6 text-meso-gold-400" />
        </div>
        <div className="flex-1">
          ...
          <p className="text-white/70 mb-4">
            ...
            <span className="text-meso-gold-400 font-bold">50 punktów</span> na start.
            Zbieraj punkty za każde zamówienie i wymieniaj na darmowe dania!
          </p>

          <div className="flex flex-wrap gap-3 mb-4">
            <div className="flex items-center gap-2 text-sm text-white/60">
              <span className="text-meso-gold-400">✓</span>
              1 zł = 1 punkt
            </div>
            <div className="flex items-center gap-2 text-sm text-white/60">
              <span className="text-meso-gold-400">✓</span>
