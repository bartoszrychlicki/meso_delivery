            ...
            <DrawerContent className="bg-meso-dark-900 border-t-meso-dark-800 text-white max-h-[90vh]">
                <div className="mx-auto w-full max-w-lg flex flex-col h-full overflow-hidden">
                    {loading && !product ? (
                        ...
                        <>
                            {/* Header Image & Info */}
                            <div className="flex-shrink-0 relative h-48 w-full bg-meso-dark-800">
                                ...
                                <DrawerClose asChild>
                                    <button className="absolute top-4 right-4 p-2 bg-black/40 rounded-full text-white hover:bg-black/60 transition-colors">
                            ...
                            {/* Fixed Footer */}
                            <div className="p-4 border-t border-meso-dark-800 bg-meso-dark-900 absolute bottom-0 left-0 right-0 z-10">
